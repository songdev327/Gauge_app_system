...
export default function ImportExcel() {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const res = await axios.post(`${config.api_path}/upload-excel`, formData, {
        ...
        <>
            <TemplatePro>
                <div className="content-wrapper">
                    ...
                    <h3 className="fw-bold mb-3 mt-5">📁 UPLOAD EXCEL เข้าตาราง INDEX</h3>
                    <input
                        type="file"
                        accept=".xlsx, .xls"
                    ...
                    <button onClick={handleUpload} className="btn btn-success mt-3 mb-5" id="export-excel">
                        🚀 IMPORT EXCEL INDEX TO DATABASE
                    </button>
                </div>
            </TemplatePro>
        </>
